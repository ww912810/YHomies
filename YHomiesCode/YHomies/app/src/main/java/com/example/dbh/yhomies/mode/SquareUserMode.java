...
public class SquareUserMode {
     ...
     * @param iSquarePopularityMode
     */
    public static void getSquareNearby(final ISquarePopularityMode iSquarePopularityMode) {
        RequestParams params = new RequestParams(HttpUrlUtils.MY_SQUARE);
        params.addBodyParameter("lon", "0");
        params.addBodyParameter("lat", "0");
        x.http().get(params, new MyCallBack() {
            ...
            public void onSuccess(String result) {
                super.onSuccess(result);
                //人气数据
                ArrayList<UserBean> data = getDataNearbyList(result, "nearby");
                iSquarePopularityMode.onSuccess(data);
            }
     ...
     * @return
     */
    private static ArrayList<UserBean> getDataNearbyList(String result, String type) {
