...
/**
 * Created by chenzhi on 2018/6/29 0029.
 */

@SuppressLint("AppCompatCustomView")
public class MyTrapezoidalImageView extends ImageView {
    ...
    public MyTrapezoidalImageView(Context context) {
        super(context);
        mContext = context;
        translucent = getResources().getColor(R.color.translucent);
    }

    public MyTrapezoidalImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        translucent = getResources().getColor(R.color.translucent);
    }

    public MyTrapezoidalImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // }
        XYPoint leftTop = new XYPoint(width * 1 / 5, 0);
